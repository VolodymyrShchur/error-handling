...
import (
	...
	"github.com/lab1/errors-logs/pkg/lib/httpserver/ctxparam"
)
...
func (srv *Server) Listen(addr string) error {
	return srv.listen(addr, func(server *http.Server) error {
...
func paramsMiddleware(next func(http.ResponseWriter, *http.Request)) httprouter.Handle {
